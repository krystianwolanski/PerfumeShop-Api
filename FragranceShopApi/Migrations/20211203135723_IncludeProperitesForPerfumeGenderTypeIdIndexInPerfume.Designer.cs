...
namespace FragranceShopApi.Migrations
{
    ...
    [Migration("20211203135723_IncludeProperitesForPerfumeGenderTypeIdIndexInPerfume")]
    partial class IncludeProperitesForPerfumeGenderTypeIdIndexInPerfume
    {
            ...
            modelBuilder.Entity("FragranceShopApi.Entities.Perfume", b =>
                {
                    ...
                    b.HasIndex("PerfumeGenderTypeId")
                        .IsClustered(false)
                        .HasAnnotation("SqlServer:Include", new[] { "Quantity", "Price", "BasePrice", "Capacity", "PerfumeBrandId", "PerfumerId", "Year", "Name" });
