...
namespace FragranceShopApi.Migrations
{
    ...
    [Migration("20210802101720_AddFragranceNotes")]
    partial class AddFragranceNotes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FragranceNotePerfume", b =>
                {
                    b.Property<int>("FragranceNotesId")
                        .HasColumnType("int");

                    b.Property<int>("PerfumesId")
                        .HasColumnType("int");

                    b.HasKey("FragranceNotesId", "PerfumesId");

                    b.HasIndex("PerfumesId");

                    b.ToTable("FragranceNotePerfume");
                });
            ...
            modelBuilder.Entity("FragranceNotePerfume", b =>
                {
                    b.HasOne("FragranceShopApi.Entities.FragranceNote", null)
                        .WithMany()
                        .HasForeignKey("FragranceNotesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FragranceShopApi.Entities.Perfume", null)
                        .WithMany()
