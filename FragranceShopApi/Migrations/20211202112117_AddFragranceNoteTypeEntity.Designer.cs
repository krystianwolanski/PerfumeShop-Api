...
namespace FragranceShopApi.Migrations
{
    ...
    [Migration("20211202112117_AddFragranceNoteTypeEntity")]
    partial class AddFragranceNoteTypeEntity
    {
            ...
            modelBuilder.Entity("FragranceShopApi.Entities.FragranceNotePerfume", b =>
                {
                    ...
                    b.Property<int?>("FragranceNoteTypeId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FragranceNoteTypeId1");
            ...
            modelBuilder.Entity("FragranceShopApi.Entities.FragranceNotePerfume", b =>
                {
                    ...
                    b.HasOne("FragranceShopApi.Entities.FragranceNoteType", "FragranceNoteType")
                        .WithMany()
                        .HasForeignKey("FragranceNoteTypeId1");
