...
namespace FragranceShopApi.Migrations
{
    ...
    [Migration("20211204105329_UpdatePerfumePriceColumns")]
    partial class UpdatePerfumePriceColumns
    {
            ...
            modelBuilder.Entity("FragranceShopApi.Entities.Perfume", b =>
                {
                    ...
                    b.HasIndex("PerfumeGenderTypeId")
                        .IsClustered(false)
                        .HasAnnotation("SqlServer:Include", new[] { "Quantity", "CurrentPrice", "BasePrice", "Capacity", "PerfumeBrandId", "PerfumerId", "Year", "Name" });
